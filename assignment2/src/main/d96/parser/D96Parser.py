...
class D96Parser ( Parser ):
    ...
    class InvokemethodContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitInvokemethod" ):
                return visitor.visitInvokemethod(self)
            else:
                return visitor.visitChildren(self)
    ...
    class PartinvokeContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitPartinvoke" ):
                return visitor.visitPartinvoke(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ParamexpContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitParamexp" ):
    ...
    class MemclassContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitMemclass" ):
                return visitor.visitMemclass(self)
            else:
                return visitor.visitChildren(self)
    ...
    class DestructContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDestruct" ):
                return visitor.visitDestruct(self)
            else:
                return visitor.visitChildren(self)
    ...
    def attr(self):
        ...
        self.getInvokingContext(33).lst = [0,0,0]
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 391
            ...
            while _la==D96Parser.COMMA:
                self.state = 393
                self.match(D96Parser.COMMA)
                self.getInvokingContext(33).lst[0] += 1
                self.state = 395
                self.idattr()
                self.state = 400
                self._errHandler.sync(self)
            ...
            if la_ == 1:
                self.state = 403
                self.match(D96Parser.ASSIGN)
                self.getInvokingContext(33).lst[1] = 1
                self.state = 405
                self.exp()
                self.state = 412
                self._errHandler.sync(self)
                ...
                while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                    if _alt==1:
                        self.state = 406
                        if not self.getInvokingContext(33).lst[2] < self.getInvokingContext(33).lst[0]:
                            from antlr4.error.Errors import FailedPredicateException
                            raise FailedPredicateException(self, "$attr::lst[2] < $attr::lst[0]")
                        self.state = 407
                        self.match(D96Parser.COMMA)
                        self.getInvokingContext(33).lst[2] += 1
                        self.state = 409
                        self.exp() 
                    self.state = 414
                    self._errHandler.sync(self)
            ...
            if la_ == 1:
                self.state = 417
                if not self.getInvokingContext(33).lst[0] == self.getInvokingContext(33).lst[2] and self.getInvokingContext(33).lst[1] == 1:
                    from antlr4.error.Errors import FailedPredicateException
                ...
                self.state = 419
                if not self.getInvokingContext(33).lst[1] == 0:
                    from antlr4.error.Errors import FailedPredicateException
    ...
    def vardecl(self):
        ...
        self.getInvokingContext(35).lst = [0,0,0]
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 425
            ...
            while _la==D96Parser.COMMA:
                self.state = 427
                self.match(D96Parser.COMMA)
                self.getInvokingContext(35).lst[0] += 1
                self.state = 429
                self.match(D96Parser.ID)
                self.state = 434
                self._errHandler.sync(self)
            ...
            if la_ == 1:
                self.state = 437
                self.match(D96Parser.ASSIGN)
                self.getInvokingContext(35).lst[1] = 1
                self.state = 439
                self.exp()
                self.state = 446
                self._errHandler.sync(self)
                ...
                while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                    if _alt==1:
                        self.state = 440
                        if not self.getInvokingContext(35).lst[2] < self.getInvokingContext(35).lst[0]:
                            from antlr4.error.Errors import FailedPredicateException
                            raise FailedPredicateException(self, "$vardecl::lst[2] < $vardecl::lst[0]")
                        self.state = 441
                        self.match(D96Parser.COMMA)
                        self.getInvokingContext(35).lst[2] += 1
                        self.state = 443
                        self.exp() 
                    self.state = 448
                    self._errHandler.sync(self)
            ...
            if la_ == 1:
                self.state = 451
                if not self.getInvokingContext(35).lst[0] == self.getInvokingContext(35).lst[2] and self.getInvokingContext(35).lst[1] == 1:
                    from antlr4.error.Errors import FailedPredicateException
                ...
                self.state = 453
                if not self.getInvokingContext(35).lst[1] == 0:
                    from antlr4.error.Errors import FailedPredicateException
    ...
    class ArraynestedContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArraynested" ):
                return visitor.visitArraynested(self)
            else:
                return visitor.visitChildren(self)
    ...
    class MultiarrayindexContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitMultiarrayindex" ):
                return visitor.visitMultiarrayindex(self)
            else:
                return visitor.visitChildren(self)
    ...
    class BoolnContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitBooln" ):
                return visitor.visitBooln(self)
            else:
                return visitor.visitChildren(self)
    ...
    def attr_sempred(self, localctx:AttrContext, predIndex:int):
            if predIndex == 5:
                return self.getInvokingContext(33).lst[2] < self.getInvokingContext(33).lst[0]
         

            if predIndex == 6:
                return self.getInvokingContext(33).lst[0] == self.getInvokingContext(33).lst[2] and self.getInvokingContext(33).lst[1] == 1
         

            if predIndex == 7:
                return self.getInvokingContext(33).lst[1] == 0
         

    def vardecl_sempred(self, localctx:VardeclContext, predIndex:int):
            if predIndex == 8:
                return self.getInvokingContext(35).lst[2] < self.getInvokingContext(35).lst[0]
         

            if predIndex == 9:
                return self.getInvokingContext(35).lst[0] == self.getInvokingContext(35).lst[2] and self.getInvokingContext(35).lst[1] == 1
         

            if predIndex == 10:
                return self.getInvokingContext(35).lst[1] == 0
